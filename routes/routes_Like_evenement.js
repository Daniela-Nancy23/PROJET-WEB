...
function like_evenement(){
    ...
    //route permettant d'inserer les like d'un evenement_passer dans la BD
    router.post('/insert',like_evenementController.insert_like);

    //route permettant de selectioner tout les like d'un evenement_passer dans la BD
    router.get('/:id',like_evenementController.getNbreLikeById);


    //route permettant de supprimer un like d'un evenement_passer dans la BD
